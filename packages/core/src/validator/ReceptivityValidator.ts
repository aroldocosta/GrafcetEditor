...
export class ReceptivityValidator {
   ...
   */
  public static readonly HARDWARE_PATTERN = /^(I[1-8]|E[1-8]|Q[1-8]|R[1-8]|M([1-9]|[1-9][0-9]|1[0-1][0-9]|12[0-8])|X([1-9]|[1-9][0-9]|1[0-1][0-9]|12[0-8])|T([1-9]|1[0-6])|C[1-8]|A[1-8]|1|0)$/i;
